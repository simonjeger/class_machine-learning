...
def read_in_data(patients, activation_number_of_tests):
    ...
    [X_TRAIN, pid_train] = pre_processing_deterministic(number_train_patients, mean_train, std_train, read_train_features, activation_number_of_tests)        #pull X_TRAIN together for only one row per patient
