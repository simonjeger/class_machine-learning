...
activation_shuffeling = yaml_parameters['activation_shuffeling']
...
def read_in_data():
    ...
    #if activation_shuffeling == True:                                           #this should only affect the train_features and labels and not the test_features
    #    print('Shuffeling the patients... (to make them even more sick)')
